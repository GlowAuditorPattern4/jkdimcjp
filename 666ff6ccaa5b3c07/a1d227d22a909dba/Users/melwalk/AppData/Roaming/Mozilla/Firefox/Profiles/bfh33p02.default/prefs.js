...
user_pref("accessibility.lastLoadDate", 1787273150);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1787273148);
...
user_pref("browser.slowStartup.averageTime", 10921);
...
user_pref("datareporting.sessions.current.firstPaint", 4224);
user_pref("datareporting.sessions.current.main", 525);
user_pref("datareporting.sessions.current.startTime", "1787273145050");
user_pref("datareporting.sessions.current.totalTime", 9);
user_pref("e10s.rollout.cohort", "test");
user_pref("e10s.rollout.cohortSample", "0.885063");
...
user_pref("security.sandbox.content.tempDirSuffix", "{5f81cdb8-5e4f-41dd-b91a-d484abf1ae74}");
