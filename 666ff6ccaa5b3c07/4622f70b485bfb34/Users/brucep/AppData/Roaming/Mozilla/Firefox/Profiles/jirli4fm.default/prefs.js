...
user_pref("accessibility.lastLoadDate", 1787236503);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1787236501);
...
user_pref("browser.slowStartup.averageTime", 9865);
...
user_pref("datareporting.sessions.current.firstPaint", 6398);
user_pref("datareporting.sessions.current.main", 1242);
user_pref("datareporting.sessions.current.sessionRestored", 9913);
user_pref("datareporting.sessions.current.startTime", "1787236495966");
user_pref("datareporting.sessions.current.totalTime", 6);
user_pref("e10s.rollout.cohort", "test");
user_pref("e10s.rollout.cohortSample", "0.647561");
...
user_pref("security.sandbox.content.tempDirSuffix", "{af7bcfe7-dab0-4641-87c3-717253ed4ef0}");
